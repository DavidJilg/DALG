...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.variable_config.setGeometry(QRect(415, 174, 450, 561))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 429, 557))
        ...
        self.nr_of_possible_traces_label.setGeometry(QRect(650, 10, 181, 31))
        ...
        self.label_12.setGeometry(QRect(450, 10, 201, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionShow_Welcome_Screen_Again.setText(
            QCoreApplication.translate("MainWindow", u"Show Welcome Screen Again", None))
        # if QT_CONFIG(tooltip)
        self.label_trans_config.setToolTip(QCoreApplication.translate("MainWindow",
                                                                      u"<html><head/><body><p>This area houses all the settings options which influence the timing of transition firings and how the transition firings are represented in the event log.</p></body></html>",
                                                                      None))
        ...
        # if QT_CONFIG(tooltip)
        self.avg_trans_delay.setToolTip(QCoreApplication.translate("MainWindow",
                                                                   u"<html><head/><body><p>These settings influence the amount of time that passes before a transition is fired after the previous transition finished. These general settings are used for all transitions for which no individual settings are provided.</p></body></html>",
                                                                   None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.time_delay_sd.setToolTip(QCoreApplication.translate("MainWindow",
                                                                 u"<html><head/><body><p>These settings influence the amount of time that passes before a transition is fired after the previous transition finished. These general settings are used for all transitions for which no individual settings are provided.</p></body></html>",
                                                                 None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.delay_time_delay_minimum.setToolTip(QCoreApplication.translate("MainWindow",
                                                                            u"<html><head/><body><p>These settings influence the amount of time that passes before a transition is fired after the previous transition finished. These general settings are used for all transitions for which no individual settings are provided.</p></body></html>",
                                                                            None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.delay_time_delay_maximum.setToolTip(QCoreApplication.translate("MainWindow",
                                                                            u"<html><head/><body><p>These settings influence the amount of time that passes before a transition is fired after the previous transition finished. These general settings are used for all transitions for which no individual settings are provided.</p></body></html>",
                                                                            None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.lead_time_delay_maximum.setToolTip(QCoreApplication.translate("MainWindow",
                                                                           u"<html><head/><body><p>These settings influence the amount of time that is needed for the completion of a transition. These general settings are used for all transitions for which no individual settings are provided.</p></body></html>",
                                                                           None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.lead_time_delay_minimum.setToolTip(QCoreApplication.translate("MainWindow",
                                                                           u"<html><head/><body><p>These settings influence the amount of time that is needed for the completion of a transition. These general settings are used for all transitions for which no individual settings are provided.</p></body></html>",
                                                                           None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.avg_trans_delay_3.setToolTip(QCoreApplication.translate("MainWindow",
                                                                     u"<html><head/><body><p>These settings influence the amount of time that is needed for the completion of a transition. These general settings are used for all transitions for which no individual settings are provided.</p></body></html>",
                                                                     None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.lead_time_sd.setToolTip(QCoreApplication.translate("MainWindow",
                                                                u"<html><head/><body><p>These settings influence the amount of time that is needed for the completion of a transition. These general settings are used for all transitions for which no individual settings are provided.</p></body></html>",
                                                                None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.include_invisible_transitions.setToolTip(QCoreApplication.translate("MainWindow",
                                                                                 u"<html><head/><body><p>If this setting is checked the event logs will contain events corresponding to the firing of invisible transitions.</p></body></html>",
                                                                                 None))
        # endif // QT_CONFIG(tooltip)
        self.output_dir_label_26.setText(
            QCoreApplication.translate("MainWindow", u"Include Invisible Transitions in Event Log:", None))
        self.include_invisible_transitions_input.setText("")
        # if QT_CONFIG(tooltip)
        self.include_microseconds.setToolTip(QCoreApplication.translate("MainWindow",
                                                                        u"<html><head/><body><p>If this setting is checked the timestamp of events will include microsecond precision.</p></body></html>",
                                                                        None))
        # endif // QT_CONFIG(tooltip)
        self.output_dir_label_33.setText(
            QCoreApplication.translate("MainWindow", u"Include Microseconds in Timestamps:", None))
        self.timestamp_millieseconds_input.setText("")
        # if QT_CONFIG(tooltip)
        self.variance_input.setToolTip(QCoreApplication.translate("MainWindow",
                                                                  u"<html><head/><body><p>This input allows you to add variance to the timestamp of an activity if the activity is at the beginning of a time interval. If this setting is not usesd all timestamps that are originally outside of the time intervals will be at the beginning of the next valid interval. </p></body></html>",
                                                                  None))
        # endif // QT_CONFIG(tooltip)
        self.variance_input.setText("")
        # if QT_CONFIG(tooltip)
        self.time_intervals_input.setToolTip(QCoreApplication.translate("MainWindow",
                                                                        u"<html><head/><body><p>This input allows you to restrict when the activity can be performed. Therefore, a list of time intervals can be provided. If not Intervals are provided, no restrictions aply. The following syntax has to be used:</p><p align=\"center\">Mon,Tue,Wed,Thu,Fri,Sat,Sun | 07:00:00-12:00:00;</p><p align=\"center\">Mon,Tue,Wed,Thu,Fri | 14:00:00-18:00:00;</p><p align=\"center\">.....</p></body></html>",
                                                                        None))
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.initial_value_label_7.setToolTip(QCoreApplication.translate("MainWindow",
                                                                         u"<html><head/><body><p>This input allows you to add variance to the timestamp of an activity if the activity is at the beginning of a time interval. If this setting is not usesd all timestamps that are originally outside of the time intervals will be at the beginning of the next valid interval. </p></body></html>",
                                                                         None))
        # endif // QT_CONFIG(tooltip)
        self.initial_value_label_7.setText(
            QCoreApplication.translate("MainWindow", u"Add Time Interval Variance:", None))
        # if QT_CONFIG(tooltip)
        self.initial_value_label_8.setToolTip(QCoreApplication.translate("MainWindow",
                                                                         u"<html><head/><body><p>This input allows you set the maximum variance.</p></body></html>",
                                                                         None))
        # endif // QT_CONFIG(tooltip)
        self.initial_value_label_8.setText(
            QCoreApplication.translate("MainWindow", u"Maximum Variance (Minutes):", None))
        # if QT_CONFIG(tooltip)
        self.max_variance_input.setToolTip(QCoreApplication.translate("MainWindow",
                                                                      u"<html><head/><body><p>This input allows you set the maximum variance.</p></body></html>",
                                                                      None))
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.output_dir_label_39.setToolTip(QCoreApplication.translate("MainWindow",
                                                                       u"<html><head/><body><p>This input allows you to restrict when the activity can be performed. Therefore, a list of time intervals can be provided. If not Intervals are provided, no restrictions aply. The following syntax has to be used:</p><p align=\"center\">Mon,Tue,Wed,Thu,Fri,Sat,Sun | 07:00:00-12:00:00;</p><p align=\"center\">Mon,Tue,Wed,Thu,Fri | 14:00:00-18:00:00;</p><p align=\"center\">.....</p></body></html>",
                                                                       None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.widget_2.setToolTip(QCoreApplication.translate("MainWindow",
                                                            u"<html><head/><body><p>Directory to which the generated event logs are exported.</p></body></html>",
                                                            None))
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.widget_3.setToolTip(QCoreApplication.translate("MainWindow",
                                                            u"<html><head/><body><p>Filename that is used for the generated event log. If multiple event logs are created the name will be expanded with a number.</p></body></html>",
                                                            None))
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(whatsthis)
        self.widget_3.setWhatsThis(QCoreApplication.translate("MainWindow",
                                                              u"<html><head/><body><p>Dies ist ein Test</p><p><br/></p></body></html>",
                                                              None))
        # endif // QT_CONFIG(whatsthis)
        self.output_dir_label_3.setText(QCoreApplication.translate("MainWindow", u"File Name:", None))
        # if QT_CONFIG(tooltip)
        self.widget_4.setToolTip(QCoreApplication.translate("MainWindow",
                                                            u"<html><head/><body><p>The number of event logs that are generated using the specified configuration.</p></body></html>",
                                                            None))
        # endif // QT_CONFIG(tooltip)
        self.output_dir_label_4.setText(QCoreApplication.translate("MainWindow", u"Nr. of Event Logs:", None))
        # if QT_CONFIG(tooltip)
        self.trace_estimation_2.setToolTip(QCoreApplication.translate("MainWindow",
                                                                      u"<html><head/><body><p>If this option is checked the configuration that the simulation is started with will be saved in the output dirctory. Warning: The configuration will be saved as &quot;{file name}_config.json&quot;. The file will be replaced if it already exists.</p></body></html>",
                                                                      None))
        # endif // QT_CONFIG(tooltip)
        self.include_config_label.setText(
            QCoreApplication.translate("MainWindow", u"Include Configuration in Output Directory:", None))
        self.include_config_input.setText("")
        # if QT_CONFIG(tooltip)
        self.trace_estimation_3.setToolTip(QCoreApplication.translate("MainWindow",
                                                                      u"<html><head/><body><p>If this option is checked some basic metadata will be included in the event log by using the &quot;meta_general&quot; and &quot;meta_concept&quot; XES extensions.</p></body></html>",
                                                                      None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.include_variables_in_origin_label.setToolTip(QCoreApplication.translate("MainWindow",
                                                                                     u"<html><head/><body><p>If this setting is checked the values that are generated during an transition are already included in the corresponding event. If this setting is not checked the values first appear in the following event.</p></body></html>",
                                                                                     None))
        # endif // QT_CONFIG(tooltip)
        self.include_variables_in_origin_label.setText(
            QCoreApplication.translate("MainWindow", u"Include Values in Origin Event:", None))
        # if QT_CONFIG(tooltip)
        self.inlcude_values_in_origin_event_input.setToolTip(QCoreApplication.translate("MainWindow",
                                                                                        u"<html><head/><body><p>If this setting is checked the values that are generated during an transition are already included in the corresponding event. If this setting is not checked the values first appear in the following event.</p></body></html>",
                                                                                        None))
        # endif // QT_CONFIG(tooltip)
        self.inlcude_values_in_origin_event_input.setText("")
        # if QT_CONFIG(tooltip)
        self.label_var_config.setToolTip(QCoreApplication.translate("MainWindow",
                                                                    u"<html><head/><body><p>This area houses all the settings options which influence the generation of values for the variables of the model.</p></body></html>",
                                                                    None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.progressBar.setToolTip(QCoreApplication.translate("MainWindow",
                                                               u"<html><head/><body><p>This progress bar will show the progress of the simulation if the number of event logs/traces that are generated is fixed. If the &quot;Random Exploration&quot; or &quot;All Traces&quot; strategy is chosen the progress bar will use the specified maximum number of traces or the trace estimation to show the percentage of traces generated so far.</p></body></html>",
                                                               None))
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(tooltip)
        self.label_5.setToolTip(QCoreApplication.translate("MainWindow",
                                                           u"<html><head/><body><p>The number of complete event logs that have been generated so far.</p></body></html>",
                                                           None))
        # endif // QT_CONFIG(tooltip)
        self.label_5.setText(QCoreApplication.translate("MainWindow", u"Nr. of Generated Event Logs:", None))
        # if QT_CONFIG(tooltip)
        self.nr_of_generated_logs_label.setToolTip(QCoreApplication.translate("MainWindow",
                                                                              u"<html><head/><body><p>The number of complete event logs that have been generated so far.</p></body></html>",
                                                                              None))
        # endif // QT_CONFIG(tooltip)
        self.nr_of_generated_logs_label.setText(QCoreApplication.translate("MainWindow", u"0", None))
        # if QT_CONFIG(tooltip)
        self.label_7.setToolTip(QCoreApplication.translate("MainWindow",
                                                           u"<html><head/><body><p>The total number of traces that have been generated so far.</p></body></html>",
                                                           None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.sim_status_label.setToolTip(QCoreApplication.translate("MainWindow",
                                                                    u"<html><head/><body><p>Current Status of the simulation.</p></body></html>",
                                                                    None))
        # endif // QT_CONFIG(tooltip)
        self.sim_status_label.setText(QCoreApplication.translate("MainWindow", u"Not Running", None))
        # if QT_CONFIG(tooltip)
        self.label_11.setToolTip(QCoreApplication.translate("MainWindow",
                                                            u"<html><head/><body><p>Current Status of the simulation.</p></body></html>",
                                                            None))
        # endif // QT_CONFIG(tooltip)
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"Current Status:", None))
        # if QT_CONFIG(tooltip)
        self.stop_simulation_button.setToolTip(QCoreApplication.translate("MainWindow",
                                                                          u"<html><head/><body><p>This button will end the simulation. If the simulation is ended while generating event logs the option will be given to save the event logs generated so far. </p></body></html>",
                                                                          None))
        # endif // QT_CONFIG(tooltip)
        self.stop_simulation_button.setText(QCoreApplication.translate("MainWindow", u"End/Abort\n"
                                                                                     "Simulation", None))
        # if QT_CONFIG(tooltip)
        self.nr_of_possible_traces_label.setToolTip(QCoreApplication.translate("MainWindow",
                                                                               u"<html><head/><body><p>If the model has no loop with a changing marking and the &quot;random exploration&quot; or &quot;full exploration&quot; strategy is chosen an estimation of the number of possible traces will be shown here.</p></body></html>",
                                                                               None))
        # endif // QT_CONFIG(tooltip)
        self.nr_of_possible_traces_label.setText(QCoreApplication.translate("MainWindow", u"0", None))
        # if QT_CONFIG(tooltip)
        self.label_12.setToolTip(QCoreApplication.translate("MainWindow",
                                                            u"<html><head/><body><p>If the model has no loop with a changing marking and the &quot;random exploration&quot; or &quot;full exploration&quot; strategy is chosen an estimation of the number of possible traces will be shown here.</p></body></html>",
                                                            None))
        # endif // QT_CONFIG(tooltip)
        self.label_12.setText(QCoreApplication.translate("MainWindow", u"Nr. of max possible traces:", None))
        self.label_sim_status.setText(QCoreApplication.translate("MainWindow", u"Simulation Status", None))
        # if QT_CONFIG(tooltip)
        self.loaded_model_label.setToolTip(QCoreApplication.translate("MainWindow",
                                                                      u"<html><head/><body><p>Path of the model that is currently loaded.</p></body></html>",
                                                                      None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.trace_name.setToolTip(QCoreApplication.translate("MainWindow",
                                                              u"<html><head/><body><p>The name each trace in the event log has. If multiple traces are generated the name will be expanded with a number. If the field is left empty the trace names will just be numbers.</p></body></html>",
                                                              None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.only_ending_traces.setToolTip(QCoreApplication.translate("MainWindow",
                                                                      u"<html><head/><body><p>If this option is checked only traces that reach a valid final marking are included in the event log.</p></body></html>",
                                                                      None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.timestamp_anchor.setToolTip(QCoreApplication.translate("MainWindow",
                                                                    u"<html><head/><body><p>This utc timestamp will be used as the starting time for the traces. The input format is &quot;dd.MM.yyyy hh:mm:ss&quot;.</p></body></html>",
                                                                    None))
        # endif // QT_CONFIG(tooltip)
        self.output_dir_label_13.setText(QCoreApplication.translate("MainWindow", u"Timestamp Anchor:", None))
        self.timestamp_anchor_input.setDisplayFormat(
            QCoreApplication.translate("MainWindow", u"dd.MM.yyyy HH:mm:ss", None))
        # if QT_CONFIG(tooltip)
        self.fixed_timestamp_anchor.setToolTip(QCoreApplication.translate("MainWindow",
                                                                          u"<html><head/><body><p>If this option is checked all traces will use the timestamp anchor as a starting time and therefore run in parralel. If this option is not checked each trace start with the ending timestamp of the previous trace.</p></body></html>",
                                                                          None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.include_partial_traces.setToolTip(QCoreApplication.translate("MainWindow",
                                                                          u"<html><head/><body><p>If this option is not checked only traces are included that reach a final marking or a marking in which no transition is enabled. If this option is checked all partial traces found during the simulation will also be included.</p></body></html>",
                                                                          None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.seed.setToolTip(QCoreApplication.translate("MainWindow",
                                                        u"<html><head/><body><p>The seed that is used for all pseudo random number generators used in the simulation. If the simulation is started with the same seed and settings the resulting event log will be identical every time. The seed must be a positive integer.</p></body></html>",
                                                        None))
        # endif // QT_CONFIG(tooltip)
        # if QT_CONFIG(whatsthis)
        self.seed.setWhatsThis(QCoreApplication.translate("MainWindow",
                                                          u"<html><head/><body><p>Dies ist ein Test</p><p><br/></p></body></html>",
                                                          None))
        # endif // QT_CONFIG(whatsthis)
        ...
        # if QT_CONFIG(tooltip)
        self.max_trace_duplicates.setToolTip(QCoreApplication.translate("MainWindow",
                                                                        u"<html><head/><body><p>The maximum number of duplicates traces that are allowed in each event log.</p></body></html>",
                                                                        None))
        # endif // QT_CONFIG(tooltip)
        self.output_dir_label_10.setText(QCoreApplication.translate("MainWindow", u"Max. Trace Duplicates:", None))
        # if QT_CONFIG(tooltip)
        self.sim_strategy.setToolTip(QCoreApplication.translate("MainWindow",
                                                                u"<html><head/><body><p>Simulation mode that is used for the generation of traces.</p></body></html>",
                                                                None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.duplicates_with_data.setToolTip(QCoreApplication.translate("MainWindow",
                                                                        u"<html><head/><body><p>This option controls whether the variables of events are considered when determining if two traces are equal. If this option is unchecked only the sequence of events is considered. If this option is checked the variable values of each event are also considered.</p></body></html>",
                                                                        None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.nr_of_traces.setToolTip(QCoreApplication.translate("MainWindow",
                                                                u"<html><head/><body><p>The number of traces that will be generated for each event log.</p></body></html>",
                                                                None))
        # endif // QT_CONFIG(tooltip)
        self.nr_of_traces_label.setText(QCoreApplication.translate("MainWindow", u"Nr. of Traces:", None))
        # if QT_CONFIG(tooltip)
        self.utc_offset.setToolTip(QCoreApplication.translate("MainWindow",
                                                              u"<html><head/><body><p>The utc offset for the timestamp anchor. </p></body></html>",
                                                              None))
        # endif // QT_CONFIG(tooltip)
        self.output_dir_label_23.setText(QCoreApplication.translate("MainWindow", u"Utc Offset:", None))
        # if QT_CONFIG(tooltip)
        self.max_trace_length.setToolTip(QCoreApplication.translate("MainWindow",
                                                                    u"<html><head/><body><p>The maximum number of fired transitions that are allowed in a each trace. If the &quot;Include Invisible Transitions in Event Log&quot; setting is activated the invisible transitions will also be considered.</p></body></html>",
                                                                    None))
        # endif // QT_CONFIG(tooltip)
        self.output_dir_label_8.setText(QCoreApplication.translate("MainWindow", u"Max. Trace Length:", None))
        # if QT_CONFIG(tooltip)
        self.max_loop_iterations.setToolTip(QCoreApplication.translate("MainWindow",
                                                                       u"<html><head/><body><p>Maximum number of times a marking is allowed to appear in a trace. This setting therefore controls the number of loop iterations for loops without changing markings.</p></body></html>",
                                                                       None))
        # endif // QT_CONFIG(tooltip)
        self.output_dir_label_9.setText(
            QCoreApplication.translate("MainWindow", u"Max. Loop Iterations (Marking):", None))
        # if QT_CONFIG(tooltip)
        self.min_trace_length.setToolTip(QCoreApplication.translate("MainWindow",
                                                                    u"<html><head/><body><p>The minimum number of events (e.g., nr. of fired transitions) that are allowed in a each trace.  If the &quot;Include Invisible Transitions in Event Log&quot; setting is activated the invisible transitions will also be considered.</p></body></html>",
                                                                    None))
        # endif // QT_CONFIG(tooltip)
        self.output_dir_label_24.setText(QCoreApplication.translate("MainWindow", u"Min. Trace Length:", None))
        # if QT_CONFIG(tooltip)
        self.duplicates_with_invisible_trans.setToolTip(QCoreApplication.translate("MainWindow",
                                                                                   u"<html><head/><body><p>This option controls whether invisible transitions are considered when determining if two traces are equal. If this option is unchecked only the sequence of transitions that are not invisible is considered. If this option is checked the sequence of all transitions is considered.</p></body></html>",
                                                                                   None))
        # endif // QT_CONFIG(tooltip)
        self.output_dir_label_32.setText(
            QCoreApplication.translate("MainWindow", u"Duplicates with Invisible Transitions:", None))
        # if QT_CONFIG(tooltip)
        self.duplicates_with_invisible_trans_input.setToolTip(QCoreApplication.translate("MainWindow",
                                                                                         u"<html><head/><body><p>This option controls whether the invisible transitions are considered when determining if two traces are equal. If this option is checked the sequence of transitions that is compared between the traces will include the invisible transitions.</p></body></html>",
                                                                                         None))
        # endif // QT_CONFIG(tooltip)
        self.duplicates_with_invisible_trans_input.setText("")
        # if QT_CONFIG(tooltip)
        self.changing_loop.setToolTip(QCoreApplication.translate("MainWindow",
                                                                 u"<html><head/><body><p>Information about whether the model has a loop that does not return to a common marking. If you are unsure if your model contains a such a loop, it is better to leave this option unchecked. If the model has no such loop the number of possible traces can be estimated and displayed. However this estimation will result in an infinite loop if a loop with a changing marking is present.</p></body></html>",
                                                                 None))
        # endif // QT_CONFIG(tooltip)
        self.output_dir_label_15.setText(
            QCoreApplication.translate("MainWindow", u"Model has no Loop with Changing Marking:", None))
        self.changing_loop_input.setText("")
        # if QT_CONFIG(tooltip)
        self.max_loop_iterations_transition.setToolTip(QCoreApplication.translate("MainWindow",
                                                                                  u"<html><head/><body><p>Maximum number of times a transition is allowed to appear in a trace. This setting therefore can controls the number of loop iterations for loops with changing markings. However models can exists where a transition can be fired multiple times without a loop being present. Therefore this setting should be used with caution since it can also restraints transition firings that are not part of a loop.</p></body></html>",
                                                                                  None))
        # endif // QT_CONFIG(tooltip)
        self.output_dir_label_25.setText(
            QCoreApplication.translate("MainWindow", u"Max. Loop Iterations (Transitions):", None))
        # if QT_CONFIG(tooltip)
        self.trace_estimation.setToolTip(QCoreApplication.translate("MainWindow",
                                                                    u"<html><head/><body><p>This options controls whether a estimation of the maximum number of possible traces is performed before the simulation. </p></body></html>",
                                                                    None))
        # endif // QT_CONFIG(tooltip)
        ...
        # if QT_CONFIG(tooltip)
        self.limit_variable_values.setToolTip(QCoreApplication.translate("MainWindow",
                                                                         u"<html><head/><body><p>This option helps to reduce the number of possible variable value combinations by limiting the values for variables to values that are needed to satisfy guard conditions in the model. </p></body></html>",
                                                                         None))
        # endif // QT_CONFIG(tooltip)
