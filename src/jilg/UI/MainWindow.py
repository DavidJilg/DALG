...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QRect(1020, 145, 191, 31))
        font1 = QFont()
        ...
        self.time_delay_minimum = QWidget(self.general_config_2)
        self.time_delay_minimum.setObjectName(u"time_delay_minimum")
        self.time_delay_minimum.setGeometry(QRect(20, 179, 391, 25))
        ...
        self.time_delay_maximum = QWidget(self.general_config_2)
        self.time_delay_maximum.setObjectName(u"time_delay_maximum")
        self.time_delay_maximum.setGeometry(QRect(20, 210, 391, 25))
        ...
        self.output_dir_label_22 = QLabel(self.general_config_2)
        self.output_dir_label_22.setObjectName(u"output_dir_label_22")
        self.output_dir_label_22.setGeometry(QRect(310, 90, 101, 23))
        self.output_dir_label_22.setFont(font)
        self.output_dir_label_22.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        self.output_dir_label_17 = QLabel(self.general_config_2)
        self.output_dir_label_17.setObjectName(u"output_dir_label_17")
        self.output_dir_label_17.setGeometry(QRect(255, 90, 41, 23))
        self.output_dir_label_17.setFont(font)
        self.output_dir_label_17.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        self.line_3 = QFrame(self.general_config_2)
        self.line_3.setObjectName(u"line_3")
        self.line_3.setGeometry(QRect(165, 10, 245, 1))
        ...
        self.line_6.setGeometry(QRect(0, 10, 9, 1))
        ...
        self.time_delay_maximum_3.setObjectName(u"time_delay_maximum_3")
        self.time_delay_maximum_3.setGeometry(QRect(20, 352, 391, 25))
        self.output_dir_label_28 = QLabel(self.time_delay_maximum_3)
        ...
        self.time_lead_maximum_time_input = QTimeEdit(self.time_delay_maximum_3)
        ...
        self.time_lead_maximum_days_input = QSpinBox(self.time_delay_maximum_3)
        ...
        self.time_delay_minimum_3 = QWidget(self.general_config_2)
        self.time_delay_minimum_3.setObjectName(u"time_delay_minimum_3")
        self.time_delay_minimum_3.setGeometry(QRect(20, 321, 391, 25))
        self.output_dir_label_29 = QLabel(self.time_delay_minimum_3)
        ...
        self.time_lead_minimum_days_input = QSpinBox(self.time_delay_minimum_3)
        ...
        self.time_lead_minimum_time_input = QTimeEdit(self.time_delay_minimum_3)
        ...
        self.time_delay_sd_3 = QWidget(self.general_config_2)
        self.time_delay_sd_3.setObjectName(u"time_delay_sd_3")
        self.time_delay_sd_3.setGeometry(QRect(20, 290, 391, 25))
        self.output_dir_label_27 = QLabel(self.time_delay_sd_3)
        ...
        self.time_lead_sd_days_input = QSpinBox(self.time_delay_sd_3)
        ...
        self.time_lead_sd_time_input = QTimeEdit(self.time_delay_sd_3)
        ...
        self.include_invisible_transitions_2 = QWidget(self.general_config_2)
        self.include_invisible_transitions_2.setObjectName(u"include_invisible_transitions_2")
        self.include_invisible_transitions_2.setGeometry(QRect(10, 60, 391, 22))
        self.output_dir_label_33 = QLabel(self.include_invisible_transitions_2)
        ...
        self.timestamp_millieseconds_input = QCheckBox(self.include_invisible_transitions_2)
        ...
        self.label_2.setGeometry(QRect(120, 108, 171, 31))
        self.label_2.setFont(font1)
        self.label_3 = QLabel(self.centralwidget)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(100, 323, 201, 31))
        self.label_3.setFont(font1)
        self.general_config = QScrollArea(self.centralwidget)
        self.general_config.setObjectName(u"general_config")
        self.general_config.setGeometry(QRect(20, 138, 361, 181))
        self.general_config.setFrameShadow(QFrame.Sunken)
        self.general_config.setLineWidth(1)
        self.general_config.setWidgetResizable(True)
        self.scrollAreaWidgetContents_4 = QWidget()
        self.scrollAreaWidgetContents_4.setObjectName(u"scrollAreaWidgetContents_4")
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 359, 179))
        ...
        self.output_dir_label_37 = QLabel(self.trace_estimation_2)
        self.output_dir_label_37.setObjectName(u"output_dir_label_37")
        self.output_dir_label_37.setGeometry(QRect(0, 0, 311, 21))
        self.output_dir_label_37.setFont(font2)
        self.output_dir_label_37.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        ...
        self.variable_config.setGeometry(QRect(408, 174, 450, 561))
        self.variable_config.setFrameShape(QFrame.StyledPanel)
        self.variable_config.setFrameShadow(QFrame.Sunken)
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 431, 559))
        ...
        self.line_7 = QFrame(self.general_config_3)
        self.line_7.setObjectName(u"line_7")
        self.line_7.setGeometry(QRect(165, 10, 245, 1))
        self.line_7.setFrameShadow(QFrame.Plain)
        self.line_7.setFrameShape(QFrame.HLine)
        self.line_8 = QFrame(self.general_config_3)
        self.line_8.setObjectName(u"line_8")
        self.line_8.setGeometry(QRect(-1, 10, 3, 61))
        self.line_8.setFrameShadow(QFrame.Plain)
        self.line_8.setFrameShape(QFrame.VLine)
        self.line_9 = QFrame(self.general_config_3)
        self.line_9.setObjectName(u"line_9")
        self.line_9.setGeometry(QRect(0, 10, 9, 1))
        self.line_9.setFrameShadow(QFrame.Plain)
        self.line_9.setFrameShape(QFrame.HLine)
        self.line_10 = QFrame(self.general_config_3)
        self.line_10.setObjectName(u"line_10")
        self.line_10.setGeometry(QRect(-1, 70, 412, 1))
        self.line_10.setFrameShadow(QFrame.Plain)
        self.line_10.setFrameShape(QFrame.HLine)
        self.line_11 = QFrame(self.general_config_3)
        self.line_11.setObjectName(u"line_11")
        self.line_11.setGeometry(QRect(409, 10, 3, 60))
        self.line_11.setFrameShadow(QFrame.Plain)
        self.line_11.setFrameShape(QFrame.VLine)
        self.output_dir_label_31 = QLabel(self.general_config_3)
        self.output_dir_label_31.setObjectName(u"output_dir_label_31")
        self.output_dir_label_31.setGeometry(QRect(20, 30, 231, 21))
        self.output_dir_label_31.setFont(font2)
        ...
        self.label_4.setGeometry(QRect(550, 145, 171, 31))
        ...
        self.scrollAreaWidgetContents_5.setGeometry(QRect(0, 0, 924, 109))
        ...
        self.label_6.setGeometry(QRect(360, 40, 71, 31))
        ...
        self.label_8.setGeometry(QRect(620, 40, 251, 31))
        ...
        self.label_10.setGeometry(QRect(650, 10, 181, 31))
        ...
        self.label_9.setGeometry(QRect(810, 2, 135, 21))
        self.label_9.setFont(font1)
        self.scrollArea = QScrollArea(self.centralwidget)
        self.scrollArea.setObjectName(u"scrollArea")
        self.scrollArea.setGeometry(QRect(20, 28, 361, 75))
        self.scrollArea.setWidgetResizable(True)
        self.scrollAreaWidgetContents_6 = QWidget()
        self.scrollAreaWidgetContents_6.setObjectName(u"scrollAreaWidgetContents_6")
        self.scrollAreaWidgetContents_6.setGeometry(QRect(0, 0, 359, 73))
        ...
        self.load_model_button.setGeometry(QRect(282, 5, 71, 61))
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QRect(0, 0, 342, 379))
        ...
        self.trace_name_input.setGeometry(QRect(140, 0, 181, 25))
        ...
        self.timestamp_anchor_input.setGeometry(QRect(160, 0, 161, 25))
        ...
        self.sim_strategy_input.setGeometry(QRect(140, 0, 181, 25))
        ...
        self.max_loop_iterations_input.setGeometry(QRect(240, 0, 81, 25))
        ...
        self.max_loop_iterations_transitions_input.setGeometry(QRect(240, 0, 81, 25))
        ...
        self.limit_variable_values.setGeometry(QRect(0, 370, 321, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>This area houses all the settings options which influence the timing of transition firings and how the transition firings are represented in the event log.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label.setText(QCoreApplication.translate("MainWindow", u"Transition Configuration", None))
...
#if QT_CONFIG(tooltip)
        self.time_delay_minimum.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>These settings influence the amount of time that passes before a transition is fired after the previous transition finished. These general settings are used for all transitions for which no individual settings are provided.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.time_delay_maximum.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>These settings influence the amount of time that passes before a transition is fired after the previous transition finished. These general settings are used for all transitions for which no individual settings are provided.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.output_dir_label_22.setText(QCoreApplication.translate("MainWindow", u"Hours:Min:Sec", None))
        self.output_dir_label_17.setText(QCoreApplication.translate("MainWindow", u"Days", None))
#if QT_CONFIG(tooltip)
        self.time_delay_maximum_3.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>These settings influence the amount of time that is needed for the completion of a transition. These general settings are used for all transitions for which no individual settings are provided.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.time_delay_minimum_3.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>These settings influence the amount of time that is needed for the completion of a transition. These general settings are used for all transitions for which no individual settings are provided.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.time_delay_sd_3.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>These settings influence the amount of time that is needed for the completion of a transition. These general settings are used for all transitions for which no individual settings are provided.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.include_invisible_transitions_2.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>If this setting is checked the timestamp of events will include microsecond precision.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"General Configuration", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Simulation Configuration", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.output_dir_label_37.setText(QCoreApplication.translate("MainWindow", u"Include Configuration in Output Directory:", None))
...
#if QT_CONFIG(tooltip)
        self.output_dir_label_31.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>If this setting is checked the values that are generated during an transition are already included in the corresponding event. If this setting is not checked the values first appear in the following event.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.output_dir_label_31.setText(QCoreApplication.translate("MainWindow", u"Include Values in Origin Event:", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.label_4.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>This area houses all the settings options which influence the generation of values for the variables of the model.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Variable Configuration", None))
...
#if QT_CONFIG(tooltip)
        self.label_6.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>The number of complete event logs that have been generated so far.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
...
"Simulation", None))
#if QT_CONFIG(tooltip)
        self.label_10.setToolTip(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>If the model has no loop with a changing marking and the &quot;random exploration&quot; or &quot;full exploration&quot; strategy is chosen an estimation of the number of possible traces will be shown here.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        ...
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"Simulation Status", None))
#if QT_CONFIG(tooltip)
